...
(1, 7, 7, 6, 'test title', '{\"Roller\":\"2\"}', 1000, 10, 'yes', '1900-01-09', 100, 'best product wanted', 'active', NULL, NULL),
(2, 10, 7, 6, 'deal sone one', '{\"name\":\"John\", \"age\":30, \"car\":null}', 25000, 250, 'no', '2022-07-06', 3, 'goodo', 'completed', '2022-07-17 06:02:08', '2022-07-17 06:02:08'),
(3, 7, 8, 1, 'deal done', '{\"name\":\"John\", \"age\":30, \"car\":null}', 50000, 25000, 'no', '2022-07-27', 5, 'not so bad', 'pending', '2022-07-16 06:02:08', '2022-07-16 06:02:08');
...
(13, '2022_07_16_220803_create_collections_table', 4);
...
INSERT INTO `slider` (`id`, `img`, `title`, `subtitle`, `created_at`, `updated_at`) VALUES
(3, 'cfa0860e83a4c3a763a7e62d825349f7.jpg', 'Trucking Transportataion', '6+ Years of excellence in', '2022-06-24 04:31:10', '2022-06-26 09:01:22'),
(14, 'cdc0d6e63aa8e41c89689f54970bb35f.jpg', 'We believe sustainability', 'We Deal With Clients\'s Requirements.', '2022-06-26 08:53:45', '2022-06-26 09:05:13'),
(15, '20220625100542.jpg', 'We Haul, You call', 'In World Of Excellence.', '2022-06-26 09:05:43', '2022-06-26 09:05:43');
...
(1, 1, 10000, 'Shimran', 'pending', '2022-06-28', 'Shimaran bank', '12345', '2022-06-26 12:25:03', '2022-06-26 12:30:46'),
(2, 2, 100000, 'Ratan', 'active', '2022-07-17', 'Rupali Bank Ltd', '15042364', '2022-07-18 08:10:25', '2022-07-18 08:10:25'),
(3, 1, 15000, 'maisa', 'active', '2022-07-17', 'Agraniu Bank', '15042364', '2022-07-18 08:10:25', '2022-07-18 08:10:25'),
(5, 3, 150000, 'admin', 'active', '2022-07-20', 'Padma', 'arid-rakib-maru', '2022-07-21 10:08:08', '2022-07-21 10:09:23');
...
(7, 6, 1, 6, 'work order title', '{\"test\":\"test\"}', 1000, '2022-06-25 11:27:40', '50', 'best', 'active', NULL, '2022-06-28 01:16:02'),
(8, 2, 3, 5, '8 machin urgently need', '{\"test\":\"test\"}', 500000, '2022-06-28 00:14:22', 'not bad', 'good', 'inactive', '2022-06-13 07:23:35', '2022-06-28 01:16:00'),
(9, 2, 4, 6, 'Need 10 machine', '{\"name\":\"John\", \"age\":30, \"car\":null}', 25000, '2022-07-17 09:18:34', '10', 'good', 'active', '2022-06-13 07:23:35', '2022-06-12 07:31:52'),
(10, 2, 3, 1, 'Need well machine for work', '{\"name\":\"John\", \"age\":30, \"car\":null}', 58700, '2022-07-17 09:18:34', 'not bad', 'not bad so', 'active', '2022-07-04 07:18:34', '2022-07-04 07:18:34');
...
--
ALTER TABLE `collections`
  ADD CONSTRAINT `collections_deal_id_foreign` FOREIGN KEY (`deal_id`) REFERENCES `deals` (`id`);
...
--
ALTER TABLE `withdrawals`
  ADD CONSTRAINT `withdrawals_ibfk_1` FOREIGN KEY (`deal_id`) REFERENCES `deals` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
