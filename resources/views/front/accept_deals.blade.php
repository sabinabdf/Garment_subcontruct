  ...
  <div class="container">
    <div class="row"> 
      ...
      <div class="log-box col-md-8" style="margin-left:100px">
        <form class="log-form" method="POST" action="{{route('accept_deal')}}" enctype="multipart/form-data">
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                  ...
                  <select name="merchant_id" id="">
                    {{-- <option value="">Select Merchant Company</option> --}}
                      <option value="{{$proposal->workorder->Companies->id}}">{{$proposal->workorder->Companies->name}}</option>
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                      ...
                      <select name="seller_id" id="">
                        {{-- <option value="">Select Seller Company</option> --}}
                          <option value="{{$proposal->machinepost->usermachine->companyName->id}}">{{$proposal->machinepost->usermachine->companyName->name}}</option>
                          {{-- {{$proposal->machinepostID->usermachine->companyName->id}} --}}
                ...
                <div class="form-group">
                      ...
                      <select name="machine_id" id="">
                        ...
                        {{-- <option value="">Select Machine</option> --}}
                          <option value="{{$proposal->machinePost->usermachineID->machine->id}}">{{$proposal->machinePost->usermachineID->machine->name}}</option>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label>Title</label>
                  <input type="text" class="form-control"  name="title" value="{{$proposal->title}}" required>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                        ...
                        <input id="specifications" type="text" class="form-control @error('specifications') is-invalid @enderror" name="spec_title[]" value="" required autocomplete="specifications" autofocus >
                ...
                <div class="col-md-6">
                  <div class="form-group">
                        ...
                        <input id="specifications" type="text" class="form-control @error('specifications') is-invalid @enderror" name="spec_value[]" value="" required autocomplete="specifications" autofocus >
              ...
              <a class="btn btn-info" id="addMore" style="margin-top: -35px;margin-left: -35px">+</a>


            <div class="col-md-6">
              <div class="form-group">
                <label>Budget</label>
                <input type="text" class="form-control"  name="budget" value="{{$proposal->budget}}
                " required>
            ...
            <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control"  name="advance_amount" value="" required>
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control"  name="deadline" value=" {{$proposal->deadline}}" required>
            ...
            <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="quantity" value="{{$proposal->quantity}}" required>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="quality_related" value="{{$proposal->quality_related}}" required>
            ...
            <div class="col-md-12">
              <div class="form-group text-center mrg-top-15">
                <button type="submit" class="btn theme-btn btn-m full-width">Accept Deal</button>
              </div>
            </div>
