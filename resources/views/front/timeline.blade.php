            ...
            <div class="vertical-job-body">
              <div class="row">
                ...
                <div class="col-md-3 col-sm-12 col-xs-12">
                  <div class="vrt-job-act"> <a href="{{route('view_timeline',$l->id)}}"  class="btn-job theme-btn job-apply">View Post</a> <a href="job-detail.html" title="" class="btn-job light-gray-btn">View more</a> </div>
                </div>
              </div>
            </div>            
          </div>
          ...
          <div class="vertical-job-card">
            ...
            <div class="vertical-job-body">
              <div class="row">
                ...
                <div class="col-md-3 col-sm-12 col-xs-12">
                  <div class="vrt-job-act"> <a href="{{route('go_timeline',$l->id)}}" class="btn-job theme-btn job-apply">View Post</a> <a href="job-detail.html" title="" class="btn-job light-gray-btn">View more</a> </div>
                </div>
              </div>
            </div>            
          </div>
